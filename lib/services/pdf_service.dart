...
class PdfService {
  static Future<void> printReport({required DashboardData data, required List<Sale> sales, required List<Expense> expenses, required List<Inventory> inventory}) async {
    ...
    doc.addPage(pw.MultiPage(build:(context)=>[
      ...
      pw.Text('EXECUTIVE DASHBOARD & OVERALL ANALYSIS'),
      ...
      pw.SizedBox(height:16), pw.Text('AI Analysis & Advice',style:pw.TextStyle(fontWeight:pw.FontWeight.bold)),
